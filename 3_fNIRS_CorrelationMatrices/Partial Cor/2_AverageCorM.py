...
input_folder = r"D:\Foivos\fNIRS_fMRI_Study\fNIRS_data\1_CorrelationMatrices\2_PartialCor"
...
output_file_avg = os.path.join(output_folder, "Group_Average_PartialCor_Ztransf.xlsx")
