...
select_folder = r"C:\Users\foivo\Desktop\fNIRS_fMRI_Study\fMRI_data\4_AverageCorM"
...
for file in files:
    ...
    if "Partial" in file:
        title = f"Group Average fMRI FC Matrix \n(Partial Correlations)"           # "fMRI:\n Group Average Partial Correlation Matrix"
    if "Standard" in file:
        title = f"Group Average fMRI FC Matrix \n(Bivariate Correlations)"           #"fMRI:\n Group Average Bivariate Correlation Matrix"
    out = out_folder + f"/{file.replace('.xlsx','')}_Heatmap.png"
